...
function CaseGeneralInfo({ caseData, onUpdateCase, isLoading = false, onDeleteCase, isDeleting = false, documents = [], schoolData = null }) {
  ...
  return (
    <div className="flex flex-col bg-[#0A3866]/30 backdrop-blur-3xl border-b border-[#1A71B8]/30 rounded-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_8px_32px_rgba(0,0,0,0.4)] relative" style={{ fontFamily: "'Poppins', sans-serif" }}>
      {/* Header */}
      <div className="p-3 sm:p-4 border-b border-[#1A71B8]/30 flex items-center justify-between flex-shrink-0 gap-2 relative z-30">
        ...
        {!isEditing ? (
          <div className="flex items-center gap-2 flex-shrink-0" data-tour="case-actions">
            ...
            <button
              ...
              disabled={isDeleting}
              className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 text-xs font-bold text-white bg-[#ef4444] hover:bg-[#dc2626] rounded-lg transition-all shadow-md border border-white/20 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 sm:gap-1.5 px-3 py-1.5 text-xs font-bold text-white bg-[#1A71B8] hover:bg-[#1A71B8]/80 rounded-lg transition-all shadow-md border border-white/20"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-3 py-1.5 text-xs font-bold text-white bg-[#1A71B8] hover:bg-[#1A71B8]/80 rounded-lg transition-all shadow-md border border-white/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
