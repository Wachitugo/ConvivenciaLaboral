...
function StudentEmptyState({ type = 'empty', onClearFilters }) {
    if (type === 'no-results') {
        return (
            <div className="h-full flex flex-col items-center justify-center text-center max-w-lg mx-auto px-4 py-8">
                ...
                <p className="text-sm sm:text-base text-gray-500 mb-3 sm:mb-4">No hay trabajadores que coincidan con los filtros.</p>
    ...
    return (
        <div className="h-full flex flex-col items-center justify-center text-center max-w-lg mx-auto px-4 py-8">
            ...
            <h3 className="text-base sm:text-xl font-semibold text-gray-800 mb-1 sm:mb-2">No hay trabajadores registrados</h3>
            <p className="text-sm sm:text-base text-gray-500 max-w-sm">Sube una base de datos de trabajadores para gestionar sus fichas.</p>
        </div>
    );
}
