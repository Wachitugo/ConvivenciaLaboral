...
const TOUR_STEPS = [
  {
    id: 'welcome',
    title: 'Bienvenido a Entrevistas',
    description: 'Aquí gestionas todas las entrevistas realizadas a los trabajadores en el marco de situaciones de convivencia laboral. Puedes registrar, filtrar, revisar y asociar entrevistas a expedientes. Este recorrido te mostrará las funciones principales.',
    target: null,
    badge: 'Introducción',
  },
  {
    id: 'search',
    title: 'Buscador de Entrevistas',
    description: 'Escribe el nombre del trabajador entrevistado o del entrevistador para encontrar registros de forma instantánea.',
    target: 'interview-search',
    badge: 'Búsqueda',
  },
  {
    id: 'filters',
    title: 'Filtros Principales',
    description: 'Ordena y filtra las entrevistas por distintos criterios:\n• Orden: fecha más reciente/antigua o nombre A-Z\n• Área de trabajo: filtra por departamento o unidad\n• Estado: Borrador o Autorizada\n• Género: Masculino, Femenino u Otro',
    target: 'interview-filters',
    badge: 'Filtros',
  },
  {
    id: 'more-filters',
    title: 'Filtros de Fecha',
    description: 'Haz clic en "Más filtros" para filtrar por año y mes específico. Cuando hay un filtro de fecha activo, aparece un indicador azul en el botón.',
    target: 'interview-more-filters',
    badge: 'Filtros',
  },
  {
    id: 'new-interview',
    title: 'Nueva Entrevista',
    description: 'Haz clic aquí para registrar una nueva entrevista. Podrás ingresar los datos del trabajador, el entrevistador, la fecha y el área de trabajo, además de adjuntar documentos y tomar notas.',
    target: 'interview-new-btn',
    badge: 'Acción Principal',
  },
  {
    id: 'table',
    title: 'Tabla de Entrevistas',
    description: 'Cada fila representa una entrevista registrada. Se muestran el nombre del trabajador, su género, área de trabajo, fecha, quién realizó la entrevista y el estado actual. Haz clic en cualquier fila para ver el detalle completo.',
    target: 'interview-table',
    badge: 'Vista Principal',
  },
  {
    id: 'status',
    title: 'Estados de Entrevista',
    description: 'Cada entrevista puede estar en uno de estos estados:\n• Borrador: recién creada, pendiente de completar\n• Autorizada: revisada y aprobada\n\nSolo las entrevistas Autorizadas pueden asociarse a un expediente.',
    target: 'interview-status-col',
    badge: 'Estados',
    fallbackTarget: 'interview-table',
  },
  {
    id: 'associate',
    title: 'Asociar a Expediente',
    description: 'Las entrevistas con estado "Autorizada" muestran el botón "Asociar caso". Al hacerlo, vinculas la entrevista a un expediente existente para tener toda la información centralizada.',
    target: 'interview-associate-btn',
    badge: 'Vinculación',
    fallbackTarget: 'interview-table',
  },
  {
    ...
    description: 'Marca el checkbox al inicio de cada fila para seleccionar varias entrevistas a la vez. Una vez seleccionadas, aparecerá una barra de acciones en la parte inferior para eliminarlas en bloque.',
    target: 'interview-checkbox-header',
    badge: 'Selección',
    fallbackTarget: 'interview-table',
  },
  {
    id: 'finish',
    title: 'Todo listo',
    description: 'Ya conoces las funciones principales de la vista de Entrevistas. Puedes volver a este recorrido en cualquier momento haciendo clic en el botón de ayuda en la esquina inferior derecha.',
    target: null,
    badge: 'Completado',
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <rect x="0" y="0" width={vw} height={vh} fill="rgba(5, 20, 45, 0.72)" mask="url(#interviews-tour-mask)" />
      </svg>
