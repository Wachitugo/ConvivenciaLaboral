            ...
            <div className="fixed right-0 top-0 h-full z-[70] flex items-center justify-end pointer-events-none" style={{ fontFamily: "'Poppins', sans-serif" }}>
                <div className="w-[430px] h-full shadow-[0_0_40px_rgba(0,0,0,0.5)] bg-[#0A3866]/95 backdrop-blur-3xl border-l border-[#1A71B8]/30 flex flex-col animate-slide-in overflow-hidden pointer-events-auto">
                    ...
                    <div className="px-6 py-5 border-b border-white/10 flex justify-between items-center">
                        <div>
                            <h2 className="text-lg font-bold text-white">Asociar a un Caso</h2>
                            <p className="text-xs text-white/60 mt-0.5">
                                Selecciona un caso para vincular al colaborador
                            </p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-5">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-white/50 uppercase tracking-widest">Buscar Caso</label>
                        ...
                        {/* Cases List */}
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-white/50 uppercase tracking-widest">Casos Disponibles</label>
                    ...
                    <div className="p-6 border-t border-white/10">
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className={`flex-1 px-4 py-2.5 text-white rounded-xl text-sm font-bold transition-colors shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed border border-white/10 ${selectedCaseIsAlreadyAssociated
