      ...
      <div className="relative flex flex-col gap-3 px-6 pt-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-1 flex-wrap">
            ...
            {/* Filtros principales: sortBy, status, sharedStatus */}
            ...
            <div className="h-9 w-36 bg-gray-200 rounded-lg relative overflow-hidden">
              <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-white/60 to-transparent"></div>
            </div>
          ...
          <div className="flex items-center gap-1">
            {/* Botón Nuevo Caso */}
            <div className="h-9 w-32 bg-gray-200 rounded-xl relative overflow-hidden">
              <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-white/60 to-transparent"></div>
            </div>
          </div>
        </div>
